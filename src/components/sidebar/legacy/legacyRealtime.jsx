...
import { Row, Col, Button, ButtonToolbar, ButtonGroup, Popover, OverlayTrigger } from 'react-bootstrap';
    ...
    return (
      ...
      <Row>
        <Col>
          ...
          <p><Button size="sm" variant="light">Show cumulative rainfall on the map over the last 30-60 days</Button></p>
